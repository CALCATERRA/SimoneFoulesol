...
def get_paypal_token():
    try:
        ...
        print(f"❗ Errore durante la richiesta PayPal: {str(e)}")
        raise
...
def create_payment_link(chat_id, amount):
    try:
        ...
        print(f"❗ Errore durante la creazione del link di pagamento: {str(e)}")
        raise
...
def send_payment_link(chat_id):
    try:
        ...
        print(f"❗ Errore durante l'invio del link di pagamento: {str(e)}")
...
def send_view_photo_button(chat_id):
    try:
        ...
        print(f"❗ Errore durante l'invio del pulsante per visualizzare la foto: {str(e)}")
...
def send_photo(chat_id):
    try:
        ...
        print(f"❗ Errore durante l'invio della foto a chat_id={chat_id}: {str(e)}")
